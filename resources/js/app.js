    ...
    const initAddToWatchlist = () => {
        ...
        buttons.forEach((button) => {
            button.addEventListener('click', ev => {
                ...
                // Added data-url attribute to the button in blade file
                // get the url
                ...
                axios.post(url).then((response) => {
                    ...
                    .catch(error => {
                        ...
                        if (error?.response?.status === 401) {
                            alert("Please authenticate first to add cars into your favourite list.")
                        } else {
